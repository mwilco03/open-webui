"""
Consolidated GitLab functions - Optimized for token efficiency.

Reduces 25+ GitLab functions to 5 consolidated functions with:
- Schema compression (inline docs)
- Batching support (combined API calls)
- Streaming support (user-request-aware)
- Response optimization (minimal payloads)
"""
...
DEFAULT_CONTENT_LIMIT = 10240  # 10KB default for AI proactive fetches
MAX_DIFF_SIZE = 51200  # 50KB max for diffs before truncation warning
